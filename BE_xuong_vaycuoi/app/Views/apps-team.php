        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="text-center card-box ribbon-box">
                        ...
                        <div class="pt-2 pb-2">
                            <img src="assets\images\users\avatar-3.jpg" class="rounded-circle img-thumbnail avatar-xl" alt="profile-image">
                ...
                <div class="col-lg-4">
                    <div class="text-center card-box">
                        <div class="pt-2 pb-2">
                            <img src="assets\images\users\avatar-4.jpg" class="rounded-circle img-thumbnail avatar-xl" alt="profile-image">

                            <h4 class="mt-3 font-17"><a href="extras-profile.html" class="text-dark">Christopher Gallardo</a></h4>
                ...
                <div class="col-lg-4">
                    <div class="text-center card-box">
                        <div class="pt-2 pb-2">
                            <img src="assets\images\users\avatar-5.jpg" class="rounded-circle img-thumbnail avatar-xl" alt="profile-image">

                            <h4 class="mt-3 font-17"><a href="extras-profile.html" class="text-dark">Joseph M. Rohr</a></h4>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="text-center card-box">
                        <div class="pt-2 pb-2">
                            <img src="assets\images\users\avatar-6.jpg" class="rounded-circle img-thumbnail avatar-xl" alt="profile-image">
                ...
                <div class="col-lg-4">
                    <div class="text-center card-box">
                        <div class="pt-2 pb-2">
                            <img src="assets\images\users\avatar-7.jpg" class="rounded-circle img-thumbnail avatar-xl" alt="profile-image">

                            <h4 class="mt-3 font-17"><a href="extras-profile.html" class="text-dark">James M. Fonville</a></h4>
                ...
                <div class="col-lg-4">
                    <div class="text-center card-box">
                        <div class="pt-2 pb-2">
                            <img src="assets\images\users\avatar-8.jpg" class="rounded-circle img-thumbnail avatar-xl" alt="profile-image">

                            <h4 class="mt-3 font-17"><a href="extras-profile.html" class="text-dark">Jade M. Walker</a></h4>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="text-center card-box">
                        <div class="pt-2 pb-2">
                            <img src="assets\images\users\avatar-2.jpg" class="rounded-circle img-thumbnail avatar-xl" alt="profile-image">

                            <h4 class="mt-3 font-17"><a href="extras-profile.html" class="text-dark">Marie E. Tate</a></h4>
                ...
                <div class="col-lg-4">
                    <div class="text-center card-box">
                        <div class="pt-2 pb-2">
                            <img src="assets\images\users\avatar-9.jpg" class="rounded-circle img-thumbnail avatar-xl" alt="profile-image">

                            <h4 class="mt-3 font-17"><a href="extras-profile.html" class="text-dark">Elyse D. Davidson</a></h4>
                ...
                <div class="col-lg-4">
                    <div class="text-center card-box">
                        <div class="pt-2 pb-2">
                            <img src="assets\images\users\avatar-10.jpg" class="rounded-circle img-thumbnail avatar-xl" alt="profile-image">

                            <h4 class="mt-3 font-17"><a href="extras-profile.html" class="text-dark">Sarah E. Goin</a></h4>
