            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Danh Sách Kiểu Dáng</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                    ...
                    <div class="card-box">
                        ...
                        <div class="mb-2">
                            <div class="row">
                                ...
                                <div class="col-12 text-lg-right mr-2">
                                    <a href="<?=$_SESSION['dir']?>/?add-style" class="btn btn-success">Thêm Danh Mục</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0"
                                ...
                                <thead>
                                <tr>
                                    <th data-toggle="true">Tên Kiểu Dáng</th>
...
//                                        $imagePath = "/public/images/" . $image;
                                        $xoaProduct = $_SESSION['dir']."/?delete-style&id_style=" . $id_style;
                                        $suaProduct = $_SESSION['dir']."/?update-style&id_style=" . $id_style;
