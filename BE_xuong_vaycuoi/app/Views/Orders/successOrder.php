                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="mt-3 text-center">
                                    ...
                                    <h3>Success !</h3>
                                    <p class="text-muted mt-2"> A email has been send to <span class="font-weight-medium"><?=$_POST['email']?></span>.
                                        Please check for an email from company and click on the included link to
                                        reset your password. </p>

                                    <a href="<?= $_SESSION['dir']?>/index.php" class="btn btn-block btn-primary waves-effect waves-light mt-3">Back to Home</a>
                                </div>
