            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Danh Sách Biến Thể</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                        ...
                        <div class="table-responsive">
                            <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0"
                                ...
                                <tr>
                                    ...
                                    <th data-toggle="true">Màu Sắc</th>
                                    <th data-toggle="true">Kiểu Dáng</th>
                                ...
                                <tbody>
                                <?php
                                if (isset($listBienThe)) :
                                    foreach ($listBienThe as $value) :
                                        extract($value);
