                            ...
                            <div class="col-12">
                                <div class="p-2">
                                    <form class="form-horizontal" role="form">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label" for="simpleinput">Họ tên</label>
                                            <div class="col-sm-10">
                                                <input type="text" id="simpleinput" class="form-control" value="Nhập tên nyc của bạn vào đây">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <button class="btn btn-primary waves-effect waves-light dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dropdown <i class="mdi mdi-chevron-down"></i></button>
